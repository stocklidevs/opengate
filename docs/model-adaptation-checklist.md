...
- `docs\qwen3-coder-30b-a3b-instruct-gguf.md` records Qwen3-Coder-30B-A3B-Instruct Q8_0 llama.cpp serving facts, the 128k OG/Codex CSVQL run, and the fabricated-transcript failure.
...
- `docs\glm-4-5-air-gguf.md` records GLM-4.5-Air GGUF UD-Q4_K_XL llama.cpp serving facts, two OG/Codex CSVQL runs, and the Q8_0 memory-risk note.
